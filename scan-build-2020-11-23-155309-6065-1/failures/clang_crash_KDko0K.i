...
static char_u *deleted_augroup = ((void*)0);
...
get_deleted_augroup(void)
{
 ...
 deleted_augroup = (char_u *)dcgettext (((void*)0), (char *)("--Deleted--"), 5);
...
show_autocmd(AutoPat *ap, event_T event)
{
 ...
 if (ap->group != -1)
 {
     if ((((char_u **)augroups.ga_data)[ap->group]) == ((void*)0))
  msg_puts_attr((char *)get_deleted_augroup(), highlight_attr[(int)(HLF_E)]);
     else
  msg_puts_attr((char *)(((char_u **)augroups.ga_data)[ap->group]), highlight_attr[(int)(HLF_T)]);
     msg_puts("  ");
 }
 msg_puts_attr((char *)event_nr2name(event), highlight_attr[(int)(HLF_T)]);
 last_event = event;
 last_group = ap->group;
 msg_putchar('\n');
 if (got_int)
...
{
    do { if ((ap->pat) != ((void*)0)) { vim_free(ap->pat); (ap->pat) = ((void*)0); } } while (0);
    ap->buflocal_nr = -1;
    au_need_clean = 1;
}
...
au_remove_cmds(AutoPat *ap)
{
    ...
    for (ac = ap->cmds; ac != ((void*)0); ac = ac->next)
 do { if ((ac->cmd) != ((void*)0)) { vim_free(ac->cmd); (ac->cmd) = ((void*)0); } } while (0);
    au_need_clean = 1;
}
...
aubuflocal_remove(buf_T *buf)
{
 ...
 for ((ap) = first_autopat[(int)(event)]; (ap) != ((void*)0); (ap) = (ap)->next)
  ...
  {
      verbose_enter();
      smsg(dcgettext (((void*)0), (char *)("auto-removing autocommand: %s <buffer=%d>"), 5),
...
au_new_group(char_u *name)
{
 ...
 for (i = 0; i < augroups.ga_len; ++i)
     if ((((char_u **)augroups.ga_data)[i]) == ((void*)0))
  break;
 if (i == augroups.ga_len && ga_grow(&augroups, 1) == 0)
     return -2;

 (((char_u **)augroups.ga_data)[i]) = vim_strsave(name);
 if ((((char_u **)augroups.ga_data)[i]) == ((void*)0))
     return -2;
...
au_del_group(char_u *name)
{
    ...
    i = au_find_group(name);
    if (i == -2)
 semsg(dcgettext (((void*)0), (char *)("E367: No such group: \"%s\""), 5), name);
    else if (i == current_augroup)
 emsg(dcgettext (((void*)0), (char *)("E936: Cannot delete the current group"), 5));
    else
    {
 event_T event;
 AutoPat *ap;
         ...
         event = (event_T)((int)event + 1))
 {
  ...
  {
      give_warning((char_u *)dcgettext (((void*)0), (char *)("W19: Deleting augroup that is still in use"), 5), 1);
      in_use = 1;
      event = NUM_EVENTS;
      break;
  }
 }
 vim_free((((char_u **)augroups.ga_data)[i]));
 if (in_use)
     (((char_u **)augroups.ga_data)[i]) = get_deleted_augroup();
 else
     (((char_u **)augroups.ga_data)[i]) = ((void*)0);
    }
}
...
au_find_group(char_u *name)
{
    ...
    for (i = 0; i < augroups.ga_len; ++i)
 if ((((char_u **)augroups.ga_data)[i]) != ((void*)0) && (((char_u **)augroups.ga_data)[i]) != get_deleted_augroup()
  && strcmp((char *)((((char_u **)augroups.ga_data)[i])), (char *)(name)) == 0)
     return i;
    return -2;
}
...
do_augroup(char_u *arg, int del_group)
{
    ...
    {
 if (*arg == '\000')
     emsg(dcgettext (((void*)0), (char *)(e_argreq), 5));
 else
     au_del_group(arg);
    }
 ...
 for (i = 0; i < augroups.ga_len; ++i)
 {
     if ((((char_u **)augroups.ga_data)[i]) != ((void*)0))
     {
  msg_puts((char *)(((char_u **)augroups.ga_data)[i]));
  msg_puts("  ");
     }
 }
 msg_clr_eos();
...
event_name2nr(char_u *start, char_u **end)
{
    ...
    for (p = start; *p && !((*p) == ' ' || (*p) == '\t') && *p != ',' && *p != '|'; ++p)
 ;
    for (i = 0; event_names[i].name != ((void*)0); ++i)
    {
 len = (int)strlen((char *)(event_names[i].name));
    ...
    int have_group)
{
 ...
 {
     semsg(dcgettext (((void*)0), (char *)("E215: Illegal character after *: %s"), 5), arg);
     return ((void*)0);
 }
 pat = arg + 1;
    }
    ...
    {
 for (pat = arg; *pat && *pat != '|' && !((*pat) == ' ' || (*pat) == '\t'); pat = p)
 {
     if ((int)event_name2nr(pat, &p) >= (int)NUM_EVENTS)
     {
  if (have_group)
      semsg(dcgettext (((void*)0), (char *)("E216: No such event: %s"), 5), pat);
  else
      semsg(dcgettext (((void*)0), (char *)("E216: No such group or event: %s"), 5), pat);
  return ((void*)0);
     }
 }
    }
...
do_autocmd(char_u *arg_in, int forceit)
{
 ...
 for (i = 0; i < 2; i++)
 {
  ...
  if (strncmp((char *)(cmd), (char *)("++once"), (size_t)(6)) == 0 && ((cmd[6]) == ' ' || (cmd[6]) == '\t'))
  {
      if (once)
   semsg(dcgettext (((void*)0), (char *)(e_duparg2), 5), "++once");
      once = 1;
      cmd = skipwhite(cmd + 6);
  }


  if ((strncmp((char *)(cmd), (char *)("++nested"), (size_t)(8)) == 0 && ((cmd[8]) == ' ' || (cmd[8]) == '\t')))
  {
      if (nested)
   semsg(dcgettext (((void*)0), (char *)(e_duparg2), 5), "++nested");
      nested = 1;
      cmd = skipwhite(cmd + 8);
  }


  if (strncmp((char *)(cmd), (char *)("nested"), (size_t)(6)) == 0 && ((cmd[6]) == ' ' || (cmd[6]) == '\t'))
  {
      if (nested)
   semsg(dcgettext (((void*)0), (char *)(e_duparg2), 5), "nested");
      nested = 1;
 ...
 msg_puts_title(dcgettext (((void*)0), (char *)("\n--- Autocommands ---"), 5));
 ...
 for (event = (event_T)0; (int)event < (int)NUM_EVENTS;
     ...
     once, nested, cmd, forceit, group) == 0)
  break;
    }
    else
    {
    ...
    int group)
{
 ...
 if (is_buflocal)
 {
     ...
     __builtin___sprintf_chk ((char *)buflocal_pat, 1 - 1, __builtin_object_size ((char *)buflocal_pat, 1 > 1), "<buffer=%d>", buflocal_nr);
     pat = buflocal_pat;
...
# 1140 "autocmd.c"
 ...
 if (*cmd != '\000')
 {
  ...
  if (is_buflocal && (buflocal_nr == 0
          || buflist_findnr(buflocal_nr) == ((void*)0)))
  {
      semsg(dcgettext (((void*)0), (char *)("E680: <buffer=%d>: invalid buffer number "), 5),
         buflocal_nr);
      return 0;
  }
 ...
 *did_something = 0;
 ...
 return 0;
    ...
    if (*arg == '*')
    {
 emsg(dcgettext (((void*)0), (char *)("E217: Can't execute autocommands for ALL events"), 5));
 return 0;
    }
 ...
 return 0;
    ...
    while (*arg && !ends_excmd(*arg) && !((*arg) == ' ' || (*arg) == '\t'))
 if (apply_autocmds_group(event_name2nr(arg, &arg),
          fname, ((void*)0), 1, group, curbuf, ((void*)0)))
     nothing_done = 0;

    if (nothing_done && do_msg)
 msg(dcgettext (((void*)0), (char *)("No matching autocommands"), 5));
    if (did_something != ((void*)0))
...
# 1351 "autocmd.c"
 ...
 if (buf->b_ml.ml_mfp != ((void*)0))
 {
  ...
  do_modelines(curwin == aucmd_win ? 0x20 : 0);
     }
    ...
    buf_T *buf)
{
 ...
 win = curwin;
    ...
    aco->save_prevwin_id = prevwin == ((void*)0) ? 0 : prevwin->w_id;
    if (win != ((void*)0))
    {
 ...
 (void)win_split_ins(0, 4, aucmd_win, 0);
 (void)win_comp_pos();
 p_ea = save_ea;
...
win_found:
 ...
 (void)winframe_remove(curwin, &dummy, ((void*)0));
...
{
    return (first_autopat[(int)EVENT_TEXTCHANGED] != ((void*)0));
}
...
{
    return (first_autopat[(int)EVENT_TEXTCHANGEDP] != ((void*)0));
}
...
{
    return (first_autopat[(int)EVENT_INSERTCHARPRE] != ((void*)0));
}
...
{
    return (first_autopat[(int)EVENT_CMDUNDEFINED] != ((void*)0));
}
...
{
    return (first_autopat[(int)EVENT_TEXTYANKPOST] != ((void*)0));
}
...
{
    return (first_autopat[(int)EVENT_COMPLETECHANGED] != ((void*)0));
}
    ...
    exarg_T *eap __attribute__((unused)))
{
 ...
 goto BYPASS_AU;
    ...
    if (nesting == 10)
    {
 emsg(dcgettext (((void*)0), (char *)("E218: autocommand nesting too deep"), 5));
 goto BYPASS_AU;
    }
...
# 2020 "autocmd.c"
 ...
 save_cmdbang = (long)get_vim_var_nr(32);
 if (eap != ((void*)0))
 {
     save_cmdarg = set_cmdarg(eap, ((void*)0));
     set_vim_var_nr(32, (long)eap->forceit);
 }
 else
     save_cmdarg = ((void*)0);
 ...
 if (eap != ((void*)0))
 {
     ...
     set_vim_var_nr(32, save_cmdbang);
 }
 ...
 if (active_apc_list == &patcmd)
    ...
    vim_free((((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_name));
...
block_autocmds(void)
{
 ...
 old_termresponse = get_vim_var_str(10);
...
unblock_autocmds(void)
{
    ...
    if (autocmd_blocked == 0
        && get_vim_var_str(10) != old_termresponse)
    ...
    int stop_at_last)
{
    ...
    char_u *name;
    char *s;
    char_u **sourcing_namep = &(((estack_T *)exestack.ga_data)[exestack.ga_len - 1].es_name);

    do { if ((*sourcing_namep) != ((void*)0)) { vim_free(*sourcing_namep); (*sourcing_namep) = ((void*)0); } } while (0);
  ...
  && (apc->group == -3 || apc->group == ap->group))
 {
     ...
     if (ap->buflocal_nr == 0
      ? (match_file_pat(((void*)0), &ap->reg_prog, apc->fname,
          apc->sfname, apc->tail, ap->allow_dirs))
      : ap->buflocal_nr == apc->arg_bufnr)
     {
  name = event_nr2name(apc->event);
  s = dcgettext (((void*)0), (char *)("%s Autocommands for \"%s\""), 5);
  *sourcing_namep = alloc(strlen((char *)(s))
           + strlen((char *)(name)) + ap->patlen + 1);
  if (*sourcing_namep != ((void*)0))
  {
      __builtin___sprintf_chk ((char *)*sourcing_namep, 1 - 1, __builtin_object_size ((char *)*sourcing_namep, 1 > 1), s, (char *)name, (char *)ap->pat);

      if (p_verbose >= 8)
      {
   verbose_enter();
   smsg(dcgettext (((void*)0), (char *)("Executing %s"), 5), *sourcing_namep);
   verbose_leave();
      }
  }
...
getnextac(
 ...
 getline_opt_T options __attribute__((unused)))
{
 ...
 smsg(dcgettext (((void*)0), (char *)("autocommand %s"), 5), ac->cmd);
 msg_puts("\n");
...
# 2409 "autocmd.c"
 ...
 if (ap->pat != ((void*)0) && ap->cmds != ((void*)0)
       && (ap->buflocal_nr == 0
  ? match_file_pat(((void*)0), &ap->reg_prog,
       fname, sfname, tail, ap->allow_dirs)
  : buf != ((void*)0) && ap->buflocal_nr == buf->b_fnum
    ))
 {
     retval = 1;
     break;
    ...
    char_u *
get_augroup_name(expand_T *xp __attribute__((unused)), int idx)
{
    if (idx == augroups.ga_len)
 return (char_u *)"END";
    if (idx >= augroups.ga_len)
 return ((void*)0);
    if ((((char_u **)augroups.ga_data)[idx]) == ((void*)0) || (((char_u **)augroups.ga_data)[idx]) == get_deleted_augroup())
    ...
    int doautocmd)
{
 ...
 return ((void*)0);
    ...
    if (*arg == '\000' && group != -3 && !((arg[-1]) == ' ' || (arg[-1]) == '\t'))
    {
 arg = p;
 group = -3;
    }
 ...
 xp->xp_context = 0;
    ...
    char_u *
get_event_name(expand_T *xp __attribute__((unused)), int idx)
{
    if (idx < augroups.ga_len)
    {
 if (!include_groups || (((char_u **)augroups.ga_data)[idx]) == ((void*)0)
     || (((char_u **)augroups.ga_data)[idx]) == get_deleted_augroup())
     return (char_u *)"";
 return (((char_u **)augroups.ga_data)[idx]);
    }
 ...
 *p++ = '\000';
 ...
 if (ap->pat != ((void*)0) && ap->cmds != ((void*)0)
     ...
     && (pattern == ((void*)0)
  || (buflocal_buf == ((void*)0)
      ? vim_fnamecmp((char_u *)(ap->pat), (char_u *)(pattern)) == 0
