...
int lj_meta_tailcall(lua_State *L, cTValue *tv)
{
  ...
  ((((top+1)->fr.func).gcptr32 = (uint32_t)(uintptr_t)&((((GCobj *)(L))))->gch));
  ((top+1)->fr.tp.ftsz = ((int)((char *)(top+2) - (char *)base) + FRAME_CONT));
  L->base = L->top = top+2;
# 94 "lj_meta.c"
  return 0;
}
...
static inline __attribute__((always_inline)) int tostring(lua_State *L, TValue *o)
{
  if ((((o)->it) == (~4u))) {
    return 1;
...
TValue *lj_meta_cat(lua_State *L, TValue *top, int left)
{
  ...
  do {
    int n = 1;
    if (!((((top-1)->it) == (~4u)) || (((top-1)->it) <= 0xfffeffffu)) || !tostring(L, top)) {
...
# 269 "lj_meta.c"
      ...
      return top+1;
    } else if ((&(((GCobj *)(uintptr_t)((top)->gcr).gcptr32))->str)->len == 0) {
      ...
      MSize tlen = (&(((GCobj *)(uintptr_t)((top)->gcr).gcptr32))->str)->len;
      char *buffer;
      int i;
      for (n = 1; n <= left && tostring(L, top-n); n++) {
 MSize len = (&(((GCobj *)(uintptr_t)((top-n)->gcr).gcptr32))->str)->len;
 if (len >= 0x7fffff00 - tlen)
   lj_err_msg(L, LJ_ERR_STROV);
 tlen += len;
      }
      buffer = lj_str_needbuf(L, &(((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->tmpbuf, tlen);
      n--;
      tlen = 0;
      for (i = n; i >= 0; i--) {
 MSize len = (&(((GCobj *)(uintptr_t)((top-i)->gcr).gcptr32))->str)->len;
 memcpy(buffer + tlen, ((const char *)(((&(((GCobj *)(uintptr_t)((top-i)->gcr).gcptr32))->str))+1)), len);
 tlen += len;
      }
