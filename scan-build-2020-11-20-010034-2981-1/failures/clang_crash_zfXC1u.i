...
extern __attribute__((visibility("hidden"))) GCcdata *lj_cdata_newv(lua_State *L, CTypeID id, CTSize sz,
          CTSize align);
extern __attribute__((visibility("hidden"))) GCcdata *lj_cdata_newx(CTState *cts, CTypeID id, CTSize sz,
          CTInfo info);

extern __attribute__((visibility("hidden"))) void lj_cdata_free(global_State *g, GCcdata *cd);
extern __attribute__((visibility("hidden"))) void lj_cdata_setfin(lua_State *L, GCcdata *cd, GCobj *obj,
        uint32_t it);
...
static void gc_traverse_trace(global_State *g, GCtrace *T)
{
  ...
  for (ref = T->nk; ref < REF_TRUE; ref++) {
    IRIns *ir = &T->ir[ref];
    if (ir->o == IR_KGC)
      { if (((((GCobj *)((((GCobj *)(uintptr_t)((ir)[0].gcr).gcptr32)))))->gch.marked & (0x01 | 0x02))) gc_mark(g, ((GCobj *)((((GCobj *)(uintptr_t)((ir)[0].gcr).gcptr32))))); };
    if (((((1u<<IRT_NUM)|(1u<<IRT_I64)|(1u<<IRT_U64)|(1u<<IRT_P64)|(1u<<IRT_LIGHTUD)) >> ((IRType)((ir->t).irt & IRT_TYPE))) & 1) && ir->o != IR_KNULL)
      ref++;
  }
...
static MSize gc_traverse_frames(global_State *g, lua_State *th)
{
  ...
  for (frame = th->base-1; frame > bot+0; frame = (((((ptrdiff_t)(frame)->fr.tp.ftsz) & 3) == FRAME_LUA)?((frame) - (1+0 +((BCReg)((((((const BCIns *)(void *)(uintptr_t)((frame)->fr.tp.pcr).ptr32))[-1])>>8)&0xff)))):((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4)))))) {
    ...
    if (!0) { if (((((GCobj *)(fn)))->gch.marked & (0x01 | 0x02))) gc_mark(g, ((GCobj *)(fn))); };
  }
  top++;
...
{
  TValue *o, *top = th->top;
  for (o = (((TValue *)(void *)(uintptr_t)(th->stack).ptr32))+1+0; o < top; o++)
...
static GCRef *gc_sweep(global_State *g, GCRef *p, uint32_t lim)
{
  ...
  while ((o = ((GCobj *)(uintptr_t)(*p).gcptr32)) != ((void*)0) && lim-- > 0) {
    if (o->gch.gct == ~(~6u))
      gc_sweep(g, (&(&(o)->th)->openupval), ~(uint32_t)0);
         ...
         cTValue *mo, GCobj *o)
{
  ...
  g->gc.threshold = (0 ? ((uint64_t)1<<47) : 0x7fffff00);
  top = L->top;
  copyTV(L, top++, mo);
  if (0) ((top++)->it = (~0u));
...
void lj_gc_freeall(global_State *g)
{
  ...
  gc_sweep(g, (&g->gc.root), ~(uint32_t)0);
  strmask = g->strmask;
  for (i = 0; i <= strmask; i++)
    gc_sweep(g, (&g->strhash[i]), ~(uint32_t)0);
}
...
static size_t gc_onestep(lua_State *L)
{
  ...
  case GCSpropagate:
    ...
    return 0;
  case GCSatomic:
    if ((((TValue *)(void *)(uintptr_t)(g->jit_base).ptr32)))
      return (0 ? ((uint64_t)1<<47) : 0x7fffff00);
    atomic(g, L);
  ...
  case GCSsweepstring: {
    ...
    gc_sweep(g, (&g->strhash[g->gc.sweepstr++]), ~(uint32_t)0);
...
int lj_gc_step(lua_State *L)
{
  ...
  if (lim == 0)
    lim = (0 ? ((uint64_t)1<<47) : 0x7fffff00);
...
{
  lua_State *L = (&(((GCobj *)(uintptr_t)(g->cur_L).gcptr32))->th);
