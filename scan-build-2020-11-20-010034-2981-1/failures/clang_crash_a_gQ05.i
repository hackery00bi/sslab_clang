...
extern __attribute__((visibility("hidden"))) void lj_meta_istype(lua_State *L, BCReg ra, BCReg tp);
...
extern __attribute__((visibility("hidden"))) void lj_vm_profhook(void);
...
extern __attribute__((visibility("hidden"))) double lj_vm_floor(double);
extern __attribute__((visibility("hidden"))) double lj_vm_ceil(double);
# 74 "./lj_vm.h"
...
extern __attribute__((visibility("hidden"))) double lj_vm_trunc(double);
# 101 "./lj_vm.h"
...
extern __attribute__((visibility("hidden"))) void lj_cont_stitch(void);
...
extern __attribute__((visibility("hidden"))) StrScanFmt lj_strscan_scan(const uint8_t *p, TValue *o, uint32_t opt);
extern __attribute__((visibility("hidden"))) int lj_strscan_num(GCstr *str, TValue *o);
...
static inline __attribute__((always_inline)) int lj_strscan_numberobj(TValue *o)
{
  return (((o)->it) <= 0xfffeffffu) || ((((o)->it) == (~4u)) && lj_strscan_num(((&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->str)), (o)));
}
# 23 "lj_meta.c" 2
# 1 "./lj_strfmt.h" 1
# 11 "./lj_strfmt.h"
...
# 70 "./lj_lib.h"
extern __attribute__((visibility("hidden"))) GCfunc *lj_lib_pushcc(lua_State *L, lua_CFunction f, int id, int n);
# 87 "./lj_lib.h"
...
extern __attribute__((visibility("hidden"))) void lj_lib_prereg(lua_State *L, const char *name, lua_CFunction f,
      GCtab *env);
extern __attribute__((visibility("hidden"))) int lj_lib_postreg(lua_State *L, lua_CFunction cf, int id,
      const char *name);
# 112 "./lj_lib.h"
...
void lj_meta_init(lua_State *L)
{
  ...
  const char *metanames = "__" "index" "__" "newindex" "__" "gc" "__" "mode" "__" "eq" "__" "len" "__" "lt" "__" "le" "__" "concat" "__" "call" "__" "add" "__" "sub" "__" "mul" "__" "div" "__" "mod" "__" "pow" "__" "unm" "__" "metatable" "__" "tostring" "__" "new" "__" "pairs" "__" "ipairs";
  ...
  for (mm = 0, p = metanames; *p; mm++, p = q) {
    ...
    ((g->gcroot[GCROOT_MMNAME+mm]).gcptr32 = (uint32_t)(uintptr_t)&(((GCobj *)(s)))->gch);
  }
}
...
cTValue *lj_meta_lookup(lua_State *L, cTValue *o, MMS mm)
{
  GCtab *mt;
  if ((((o)->it) == (~11u)))
    mt = (&((GCobj *)(uintptr_t)(((&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->tab)->metatable)).gcptr32)->tab);
  else if ((((o)->it) == (~12u)))
    mt = (&((GCobj *)(uintptr_t)(((&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->ud)->metatable)).gcptr32)->tab);
  else
    mt = (&((GCobj *)(uintptr_t)(((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_BASEMT+((((o)->it) <= 0xfffeffffu) ? ~(~13u) : (((int32_t)((o)->it) >> 15) == -2) ? ~(~3u) : ~((o)->it))]))).gcptr32)->tab);
  if (mt) {
    cTValue *mo = lj_tab_getstr(mt, ((&((GCobj *)(uintptr_t)((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_MMNAME+(mm)])).gcptr32)->str)));
    if (mo)
      return mo;
  }
  return (&(((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->nilnode.val);
}
...
int lj_meta_tailcall(lua_State *L, cTValue *tv)
{
  TValue *base = L->base;
  TValue *top = L->top;
  const BCIns *pc = (((const BCIns *)(void *)(uintptr_t)((base-1)->fr.tp.pcr).ptr32));
  copyTV(L, base-1-0, tv);
  if (0)
    (top++)->u64 = LJ_CONT_TAILCALL;
  else
    top->u32.lo = LJ_CONT_TAILCALL;
  ((((top++)->fr.tp.pcr).ptr32 = (uint32_t)(uintptr_t)(void *)((pc))));
  if (0) top++;
  ((((top)->fr.func).gcptr32 = (uint32_t)(uintptr_t)&((((GCobj *)(L))))->gch), ((void)((~6u))));
  ((top)->fr.tp.ftsz = (int32_t)(((char *)(top+1) - (char *)base) + FRAME_CONT));
  L->base = L->top = top+1;
# 101 "lj_meta.c"
  return 0;
}
...
# 121 "lj_meta.c"
  TValue *top = L->top;
  if (((((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->c.ffid == 0))) top = (L->base + (((GCproto *)(((char *)(void *)(uintptr_t)(((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->l.pc).ptr32)-sizeof(GCproto))))->framesize);
  ((top++)->u64 = (uint64_t)(void *)(cont) - (uint64_t)lj_vm_asm_begin);
  if (0) ((top++)->it = (~0u));
  copyTV(L, top++, mo);
  if (0) ((top++)->it = (~0u));
  copyTV(L, top, a);
...
cTValue *lj_meta_tget(lua_State *L, cTValue *o, cTValue *k)
{
  ...
  for (loop = 0; loop < 100; loop++) {
    cTValue *mo;
    if (__builtin_expect(!!((((o)->it) == (~11u))), 1)) {
      GCtab *t = (&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->tab);
      cTValue *tv = lj_tab_get(L, t, k);
      if (!(((tv)->it) == (~0u)) ||
   !(mo = (((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab)) == ((void*)0) ? ((void*)0) : (((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab))->nomm & (1u<<(MM_index))) ? ((void*)0) : lj_meta_cache((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab), MM_index, ((&((GCobj *)(uintptr_t)((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_MMNAME+(MM_index)])).gcptr32)->str))))))
 return tv;
    } else if ((((mo = lj_meta_lookup(L, o, MM_index))->it) == (~0u))) {
...
TValue *lj_meta_tset(lua_State *L, cTValue *o, cTValue *k)
{
  ...
  for (loop = 0; loop < 100; loop++) {
    ...
    if (__builtin_expect(!!((((o)->it) == (~11u))), 1)) {
      GCtab *t = (&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->tab);
      cTValue *tv = lj_tab_get(L, t, k);
      if (__builtin_expect(!!(!(((tv)->it) == (~0u))), 1)) {
 t->nomm = 0;
 { if (__builtin_expect(!!(((((GCobj *)(t)))->gch.marked & 0x04)), 0)) lj_gc_barrierback((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)), (t)); };
 return (TValue *)tv;
      } else if (!(mo = (((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab)) == ((void*)0) ? ((void*)0) : (((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab))->nomm & (1u<<(MM_newindex))) ? ((void*)0) : lj_meta_cache((&((GCobj *)(uintptr_t)((t->metatable)).gcptr32)->tab), MM_newindex, ((&((GCobj *)(uintptr_t)((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_MMNAME+(MM_newindex)])).gcptr32)->str)))))) {
 t->nomm = 0;
 { if (__builtin_expect(!!(((((GCobj *)(t)))->gch.marked & 0x04)), 0)) lj_gc_barrierback((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)), (t)); };
 if (tv != (&(((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->nilnode.val))
   return (TValue *)tv;
 if ((((k)->it) == (~0u))) lj_err_msg(L, LJ_ERR_NILIDX);
 else if ((0 && ((k)->it) == 0xfffeffffu)) { ((&tmp)->n = ((lua_Number)((int32_t)(k)->i))); k = &tmp; }
 else if ((((k)->it) < 0xfffeffffu) && ((k)->n != (k)->n)) lj_err_msg(L, LJ_ERR_NANIDX);
 return lj_tab_newkey(L, t, k);
      }
    } else if ((((mo = lj_meta_lookup(L, o, MM_newindex))->it) == (~0u))) {
      lj_err_optype(L, o, LJ_ERR_OPINDEX);
      return ((void*)0);
    }
    if ((((mo)->it) == (~8u))) {
...
static cTValue *str2num(cTValue *o, TValue *n)
{
  if ((((o)->it) < 0xfffeffffu))
    ...
    return (((n)->n = ((lua_Number)((int32_t)(o)->i))), n);
  else if ((((o)->it) == (~4u)) && lj_strscan_num((&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->str), n))
    return n;
  else
    return ((void*)0);
}
...
TValue *lj_meta_arith(lua_State *L, TValue *ra, cTValue *rb, cTValue *rc,
        BCReg op)
{
  MMS mm = ((MMS)(lj_bc_mode[op]>>11));
  TValue tempb, tempc;
  cTValue *b, *c;
  if ((b = str2num(rb, &tempb)) != ((void*)0) &&
      (c = str2num(rc, &tempc)) != ((void*)0)) {
    ((ra)->n = (lj_vm_foldarith(((b)->n), ((c)->n), (int)mm-MM_add)));
    return ((void*)0);
  } else {
...
TValue *lj_meta_cat(lua_State *L, TValue *top, int left)
{
  ...
  do {
    if (!((((top)->it) == (~4u)) || (((top)->it) <= 0xfffeffffu)) ||
 !((((top-1)->it) == (~4u)) || (((top-1)->it) <= 0xfffeffffu))) {
      cTValue *mo = lj_meta_lookup(L, top-1, MM_concat);
      if ((((mo)->it) == (~0u))) {
 mo = lj_meta_lookup(L, top, MM_concat);
 if ((((mo)->it) == (~0u))) {
   if ((((top-1)->it) == (~4u)) || (((top-1)->it) <= 0xfffeffffu)) top++;
   lj_err_optype(L, top-1, LJ_ERR_OPCAT);
   return ((void*)0);
 }
      }
# 265 "lj_meta.c"
      copyTV(L, top+2*0 +2, top);
      copyTV(L, top+2*0 +1, top-1);
      copyTV(L, top+0, mo);
      ((top-1)->u64 = (uint64_t)(void *)(lj_cont_cat) - (uint64_t)lj_vm_asm_begin);
      if (0) { ((top)->it = (~0u)); ((top+2)->it = (~0u)); top += 2; }
      return top+1;
    } else {
      ...
      TValue *e, *o = top;
      uint64_t tlen = (((o)->it) == (~4u)) ? (&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->str)->len : 32;
      SBuf *sb;
      do {
 o--; tlen += (((o)->it) == (~4u)) ? (&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->str)->len : 32;
      } while (--left > 0 && ((((o-1)->it) == (~4u)) || (((o-1)->it) <= 0xfffeffffu)));
      if (tlen >= 0x7fffff00) lj_err_msg(L, LJ_ERR_STROV);
      sb = lj_buf_tmp_(L);
      lj_buf_more(sb, (MSize)tlen);
      for (e = top, top = o; o <= e; o++) {
 if ((((o)->it) == (~4u))) {
   GCstr *s = (&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->str);
   MSize len = s->len;
   lj_buf_putmem(sb, ((const char *)((s)+1)), len);
 } else if ((0 && ((o)->it) == 0xfffeffffu)) {
   lj_strfmt_putint(sb, ((int32_t)(o)->i));
 } else {
   lj_strfmt_putfnum(sb, ((STRFMT_NUM|0x0030) | ((14+1) << 24)), ((o)->n));
 }
      }
      setstrV(L, top, lj_buf_str(L, sb));
    }
  } while (left >= 1);
  if (__builtin_expect(!!((((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->gc.total >= (((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->gc.threshold), 0)) {
    if (!fromc) L->top = (L->base + (((GCproto *)(((char *)(void *)(uintptr_t)(((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->l.pc).ptr32)-sizeof(GCproto))))->framesize);
    lj_gc_step(L);
  }
  return ((void*)0);
}
...
TValue * lj_meta_len(lua_State *L, cTValue *o)
{
  ...
  if ((((mo)->it) == (~0u))) {
    if (0 && (((o)->it) == (~11u)))
      (&((GCobj *)(uintptr_t)(((&(((GCobj *)(uintptr_t)((o)->gcr).gcptr32))->tab)->metatable)).gcptr32)->tab)->nomm |= (uint8_t)(1u<<MM_len);
    else
      lj_err_optype(L, o, LJ_ERR_OPLEN);
    return ((void*)0);
  }
  return mmcall(L, lj_cont_ra, mo, o, 0 ? o : (&(((global_State *)(void *)(uintptr_t)(L->glref).ptr32))->nilnode.val));
}
...
TValue *lj_meta_equal(lua_State *L, GCobj *o1, GCobj *o2, int ne)
{
  ...
  cTValue *mo = (((&((GCobj *)(uintptr_t)((o1->gch.metatable)).gcptr32)->tab)) == ((void*)0) ? ((void*)0) : (((&((GCobj *)(uintptr_t)((o1->gch.metatable)).gcptr32)->tab))->nomm & (1u<<(MM_eq))) ? ((void*)0) : lj_meta_cache((&((GCobj *)(uintptr_t)((o1->gch.metatable)).gcptr32)->tab), MM_eq, ((&((GCobj *)(uintptr_t)((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_MMNAME+(MM_eq)])).gcptr32)->str))));
  if (mo) {
    TValue *top;
    uint32_t it;
    if ((&((GCobj *)(uintptr_t)((o1->gch.metatable)).gcptr32)->tab) != (&((GCobj *)(uintptr_t)((o2->gch.metatable)).gcptr32)->tab)) {
      cTValue *mo2 = (((&((GCobj *)(uintptr_t)((o2->gch.metatable)).gcptr32)->tab)) == ((void*)0) ? ((void*)0) : (((&((GCobj *)(uintptr_t)((o2->gch.metatable)).gcptr32)->tab))->nomm & (1u<<(MM_eq))) ? ((void*)0) : lj_meta_cache((&((GCobj *)(uintptr_t)((o2->gch.metatable)).gcptr32)->tab), MM_eq, ((&((GCobj *)(uintptr_t)((((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->gcroot[GCROOT_MMNAME+(MM_eq)])).gcptr32)->str))));
      if (mo2 == ((void*)0) || !lj_obj_equal(mo, mo2))
 return (TValue *)(intptr_t)ne;
    }
    top = (((((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->c.ffid == 0)) ? (L->base + (((GCproto *)(((char *)(void *)(uintptr_t)(((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->l.pc).ptr32)-sizeof(GCproto))))->framesize) : L->top);
    ((top++)->u64 = (uint64_t)(void *)(ne ? lj_cont_condf : lj_cont_condt) - (uint64_t)lj_vm_asm_begin);
    if (0) ((top++)->it = (~0u));
    copyTV(L, top++, mo);
    if (0) ((top++)->it = (~0u));
...
{
  ASMFunction cont = (((BCOp)((ins)&0xff)) & 1) ? lj_cont_condf : lj_cont_condt;
  int op = (int)((BCOp)((ins)&0xff)) & ~1;
  TValue tv;
  cTValue *mo, *o2, *o1 = &L->base[((BCReg)(((ins)>>8)&0xff))];
  cTValue *o1mm = o1;
  if (op == BC_ISEQV) {
    o2 = &L->base[((BCReg)((ins)>>16))];
    if (!(((o1mm)->it) == (~10u))) o1mm = o2;
  } else if (op == BC_ISEQS) {
    setstrV(L, &tv, (&((((GCobj *)(uintptr_t)(((GCRef *)(void *)(uintptr_t)(((((GCproto *)(((char *)(void *)(uintptr_t)(((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->l.pc).ptr32)-sizeof(GCproto)))))->k).ptr32)[(~(ptrdiff_t)((BCReg)((ins)>>16)))]).gcptr32)))->str));
    o2 = &tv;
  } else if (op == BC_ISEQN) {
    o2 = &((cTValue *)(void *)(uintptr_t)((((GCproto *)(((char *)(void *)(uintptr_t)(((&((GCobj *)(uintptr_t)((L->base-1)->fr.func).gcptr32)->fn))->l.pc).ptr32)-sizeof(GCproto))))->k).ptr32)[((BCReg)((ins)>>16))];
  } else {
    ((void)0);
    ((((&tv))->it = ((~((BCReg)((ins)>>16))))));
    o2 = &tv;
  ...
  if (__builtin_expect(!!(!(((mo)->it) == (~0u))), 1))
    return mmcall(L, cont, mo, o1, o2);
  else
    return (TValue *)(intptr_t)(((BCOp)((ins)&0xff)) & 1);
}
...
{
  if (1 && ((((o1)->it) == (~10u)) || (((o2)->it) == (~10u)))) {
    ASMFunction cont = (op & 1) ? lj_cont_condf : lj_cont_condt;
    MMS mm = (op & 2) ? MM_le : MM_lt;
    cTValue *mo = lj_meta_lookup(L, (((o1)->it) == (~10u)) ? o1 : o2, mm);
    if (__builtin_expect(!!((((mo)->it) == (~0u))), 0)) goto err;
    return mmcall(L, cont, mo, o1, o2);
  } else if (0 || ((o1)->it) == ((o2)->it)) {

    if ((((o1)->it) == (~4u)) && (((o2)->it) == (~4u))) {
      int32_t res = lj_str_cmp((&(((GCobj *)(uintptr_t)((o1)->gcr).gcptr32))->str), (&(((GCobj *)(uintptr_t)((o2)->gcr).gcptr32))->str));
 ...
 if ((((mo)->it) == (~0u)) || !lj_obj_equal(mo, mo2))
 ...
 return mmcall(L, cont, mo, o1, o2);
  ...
  } else if (((((o1)->it) == (~1u)) || (((o1)->it) == (~2u))) && ((((o2)->it) == (~1u)) || (((o2)->it) == (~2u)))) {
    goto trymt;
  } else {
  err:
    lj_err_comp(L, o1, o2);
...
void lj_meta_istype(lua_State *L, BCReg ra, BCReg tp)
{
  ...
  ra++; tp--;
  ((void)0);
  if (0 && tp == ~(~13u)) lj_lib_checkint(L, ra);
  else if (tp == ~(~13u)+1) lj_lib_checknum(L, ra);
  else if (tp == ~(~4u)) lj_lib_checkstr(L, ra);
...
void lj_meta_call(lua_State *L, TValue *func, TValue *top)
{
  ...
  for (p = top; p > func+2*0; p--) copyTV(L, p, p-1);
  if (0) copyTV(L, func+2, func);
  copyTV(L, func, mo);
}
...
void lj_meta_for(lua_State *L, TValue *o)
{
  ...
  if (0) {
    ...
    ptrdiff_t i;
    for (i = 0; i <= 2; i++) {
      if ((0 && ((o+i)->it) == 0xfffeffffu)) {
 k[i] = ((int32_t)(o+i)->i); nint++;
      } else {
 k[i] = ((int32_t)(((o+i)->n))); nint += ((lua_Number)k[i] == ((o+i)->n));
      }
    }
    if (nint == 3) {
      setintV(o, k[0]);
      ...
      if ((0 && ((o)->it) == 0xfffeffffu)) ((o)->n = ((lua_Number)((int32_t)(o)->i)));
      if ((0 && ((o+1)->it) == 0xfffeffffu)) ((o+1)->n = ((lua_Number)((int32_t)(o+1)->i)));
      if ((0 && ((o+2)->it) == 0xfffeffffu)) ((o+2)->n = ((lua_Number)((int32_t)(o+2)->i)));
    }
  }
}
