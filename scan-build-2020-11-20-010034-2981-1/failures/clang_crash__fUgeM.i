...
extern __attribute__((visibility("hidden"))) const char *lj_debug_funcname(lua_State *L, cTValue *frame,
          const char **name);
extern __attribute__((visibility("hidden"))) void lj_debug_shortname(char *out, GCstr *str, BCLine line);
...
extern __attribute__((visibility("hidden"))) void lj_debug_dumpstack(lua_State *L, SBuf *sb, const char *fmt,
    int depth);
# 57 "./lj_debug.h"
enum {
  VARNAME_END,
...
FF_jit_opt_start,
FF_jit_profile_start,
FF_jit_profile_stop,
FF_jit_profile_dumpstack,
FF_ffi_meta___index,
...
extern __attribute__((visibility("hidden"))) GCtrace * lj_trace_alloc(lua_State *L, GCtrace *T);
...
extern __attribute__((visibility("hidden"))) void lj_trace_stitch(jit_State *J, const BCIns *pc);
...
static void *err_unwind(lua_State *L, void *stopcf, int errcode)
{
 ...
 return cf;
    ...
    if (frame <= (((TValue *)(void *)(uintptr_t)(L->stack).ptr32))+0)
      break;
    switch ((((ptrdiff_t)(frame)->fr.tp.ftsz) & (3|4))) {
    case FRAME_LUA:
    case FRAME_LUAP:
      frame = ((frame) - (1+0 +((BCReg)((((((const BCIns *)(void *)(uintptr_t)((frame)->fr.tp.pcr).ptr32))[-1])>>8)&0xff))));
      break;
    case FRAME_C:
    unwind_c:

      if (errcode) {
 L->base = ((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4)))) + 1;
 L->cframe = (*(void **)(((char *)(cf))+(4*8)));
 unwindstack(L, frame - 0);
      } else if (cf != stopcf) {
 cf = (*(void **)(((char *)(cf))+(4*8)));
 frame = ((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4))));
 break;
      }
      return ((void*)0);
 ...
 unwindstack(L, frame - 0);
      ...
      return cf;
    case FRAME_CONT:
      if ((1 && (((frame)-1)->u32.lo) == LJ_CONT_FFI_CALLBACK))
 goto unwind_c;
    case FRAME_VARG:
      frame = ((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4))));
      break;
 ...
 if ((((ptrdiff_t)(frame)->fr.tp.ftsz) & (3|4)) == FRAME_PCALL)
   (((((global_State *)(void *)(uintptr_t)(L->glref).ptr32)))->hookmask &= ~0x10);
 L->base = ((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4)))) + 1;
 L->cframe = cf;
 unwindstack(L, L->base);
  ...
  if (errcode) {
    L->base = (((TValue *)(void *)(uintptr_t)(L->stack).ptr32))+1+0;
    L->cframe = ((void*)0);
    unwindstack(L, L->base);
...
__attribute__((noinline)) void lj_err_throw(lua_State *L, int errcode)
{
  ...
  ((g->jit_base).ptr32 = (uint32_t)(uintptr_t)(void *)(((void*)0)));
  L->status = 0;
...
{
  cTValue *frame = L->base-1, *bot = (((TValue *)(void *)(uintptr_t)(L->stack).ptr32))+0;
  void *cf = L->cframe;
  while (frame > bot && cf) {
 ...
 return (*(int32_t *)(((char *)(cf))+(5*4)));
    ...
    case FRAME_PCALL:
    case FRAME_PCALLH:
      if ((&(((GCobj *)(uintptr_t)((((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4)))))->fr.func).gcptr32))->fn)->c.ffid == FF_xpcall)
 return ((char *)(((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4))))+1) - ((char *)(void *)(uintptr_t)(L->stack).ptr32));
      return 0;
    default:
      ((void)0);
      return 0;
...
__attribute__((noreturn)) __attribute__((noinline)) static void err_msgv(lua_State *L, ErrMsg em, ...)
{
  ...
  msg = lj_strfmt_pushvf(L, (lj_err_allmsg+(int)(em)), argp);
       ...
       BCLine line, ErrMsg em, va_list argp)
{
  ...
  if (tok)
    lj_strfmt_pushf(L, (lj_err_allmsg+(int)(LJ_ERR_XNEAR)), msg, tok);
  lj_err_throw(L, 3);
}
...
__attribute__((noinline)) void lj_err_optype_call(lua_State *L, TValue *o)
{
  ...
  if (((ptrdiff_t)pc & 3) != FRAME_LUA) {
    ...
    ((((o)->fr.func).gcptr32 = (uint32_t)(uintptr_t)&((((GCobj *)(L))))->gch), ((void)((~6u))));
    L->top = L->base = o+1;
...
__attribute__((noinline)) void lj_err_callermsg(lua_State *L, const char *msg)
{
  ...
  if (((((ptrdiff_t)(frame)->fr.tp.ftsz) & 3) == FRAME_LUA)) {
    pframe = ((frame) - (1+0 +((BCReg)((((((const BCIns *)(void *)(uintptr_t)((frame)->fr.tp.pcr).ptr32))[-1])>>8)&0xff))));
  } else if (((((ptrdiff_t)(frame)->fr.tp.ftsz) & (3|4)) == FRAME_CONT)) {
    if ((1 && (((frame)-1)->u32.lo) == LJ_CONT_FFI_CALLBACK)) {
      pframe = frame;
      frame = ((void*)0);
    } else {
      pframe = ((TValue *)((char *)(frame) - (((ptrdiff_t)(frame)->fr.tp.ftsz) & ~(3|4))));
         ...
         const char *msg)
{
  ...
  if (ftype && ftype[3] == 'h' && --narg == 0)
    msg = lj_strfmt_pushf(L, (lj_err_allmsg+(int)(LJ_ERR_BADSELF)), fname, msg);
  else
    msg = lj_strfmt_pushf(L, (lj_err_allmsg+(int)(LJ_ERR_BADARG)), narg, fname, msg);
  lj_err_callermsg(L, msg);
}
...
__attribute__((noinline)) void lj_err_argtype(lua_State *L, int narg, const char *xname)
{
 ...
 tname = lj_obj_typename[0];
  ...
  msg = lj_strfmt_pushf(L, (lj_err_allmsg+(int)(LJ_ERR_BADTYPE)), xname, tname);
  err_argmsg(L, narg, msg);
}
