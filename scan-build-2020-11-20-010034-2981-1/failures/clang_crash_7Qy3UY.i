...
for(p=L->top;p>func;p--){const TValue*o2=(p-1);TValue*o1=(p);o1->value=o2->value;o1->tt=o2->tt;;};
{if((char*)L->stack_last-(char*)L->top<=(1)*(int)sizeof(TValue))luaD_growstack(L,1);else ((void)0);;L->top++;};
...
if(!weakkey){;if(((((&(n)->i_key.nk))->tt)>=4)&&((((((&(n)->i_key.nk))->value.gc))->gch.marked)&((((1<<(0))|(1<<(1)))))))reallymarkobject(g,(((&(n)->i_key.nk))->value.gc));};
if(!weakvalue){;if(((((&(n)->i_val))->tt)>=4)&&((((((&(n)->i_val))->value.gc))->gch.marked)&((((1<<(0))|(1<<(1)))))))reallymarkobject(g,(((&(n)->i_val))->value.gc));};
}
}
...
else {TValue*i_o=(L->top);i_o->value.gc=((GCObject*)((f)));i_o->tt=6;;};
{if((char*)L->stack_last-(char*)L->top<=(1)*(int)sizeof(TValue))luaD_growstack(L,1);else ((void)0);;L->top++;};
}
if(strchr(what,'L'))
...
while(oldsize<f->sizek)((&f->k[oldsize++])->tt=0);
...
p=index2adr(L,idx);
{(void)L;};
while(++p<L->top){const TValue*o2=(p);TValue*o1=(p-1);o1->value=o2->value;o1->tt=o2->tt;;};
L->top--;
}
...
p=index2adr(L,idx);
{(void)L;};
for(q=L->top;q>p;q--){const TValue*o2=(q-1);TValue*o1=(q);o1->value=o2->value;o1->tt=o2->tt;;};
...
else lua_pushlstring(L,"""",(sizeof("")/sizeof(char))-1);
return 1;
}
...
luaL_buffinit(L,&b);
for(i=0;i<l;i++)
((void)((&b)->p<((&b)->buffer+8192)||luaL_prepbuffer(&b)),(*(&b)->p++=(char)((__extension__ ({ int __res; if (sizeof (((unsigned char)(s[i]))) > 1) { if (__builtin_constant_p (((unsigned char)(s[i])))) { int __c = (((unsigned char)(s[i]))); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (((unsigned char)(s[i]))); } else __res = (*__ctype_tolower_loc ())[(int) (((unsigned char)(s[i])))]; __res; })))));
luaL_pushresult(&b);
return 1;
}
...
luaL_buffinit(L,&b);
for(i=0;i<l;i++)
((void)((&b)->p<((&b)->buffer+8192)||luaL_prepbuffer(&b)),(*(&b)->p++=(char)((__extension__ ({ int __res; if (sizeof (((unsigned char)(s[i]))) > 1) { if (__builtin_constant_p (((unsigned char)(s[i])))) { int __c = (((unsigned char)(s[i]))); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (((unsigned char)(s[i]))); } else __res = (*__ctype_toupper_loc ())[(int) (((unsigned char)(s[i])))]; __res; })))));
luaL_pushresult(&b);
return 1;
}
...
int res;
switch((__extension__ ({ int __res; if (sizeof (cl) > 1) { if (__builtin_constant_p (cl)) { int __c = (cl); __res = __c < -128 || __c > 255 ? __c : (*__ctype_tolower_loc ())[__c]; } else __res = tolower (cl); } else __res = (*__ctype_tolower_loc ())[(int) (cl)]; __res; }))){
...
!matchbracketclass(((unsigned char)(*s)),p,ep-1))return ((void*)0);
p=ep;goto init;
}
default:{
...
int i;UB b=barg(L,1);for(i=lua_gettop(L);i>1;i--)b&=barg(L,i);lua_pushnumber(L,(lua_Number)(int)(b));return 1;}
static int bor(lua_State*L){
int i;UB b=barg(L,1);for(i=lua_gettop(L);i>1;i--)b|=barg(L,i);lua_pushnumber(L,(lua_Number)(int)(b));return 1;}
static int bxor(lua_State*L){
int i;UB b=barg(L,1);for(i=lua_gettop(L);i>1;i--)b^=barg(L,i);lua_pushnumber(L,(lua_Number)(int)(b));return 1;}
static int lshift(lua_State*L){
UB b=barg(L,1),n=barg(L,2)&31;lua_pushnumber(L,(lua_Number)(int)(b<<n));return 1;}
static int rshift(lua_State*L){
UB b=barg(L,1),n=barg(L,2)&31;lua_pushnumber(L,(lua_Number)(int)(b>>n));return 1;}
static int arshift(lua_State*L){
UB b=barg(L,1),n=barg(L,2)&31;lua_pushnumber(L,(lua_Number)(int)((int)b>>n));return 1;}
static int rol(lua_State*L){
UB b=barg(L,1),n=barg(L,2)&31;lua_pushnumber(L,(lua_Number)(int)((b<<n)|(b>>(32-n))));return 1;}
static int ror(lua_State*L){
UB b=barg(L,1),n=barg(L,2)&31;lua_pushnumber(L,(lua_Number)(int)((b>>n)|(b<<(32-n))));return 1;}
static int bswap(lua_State*L){
UB b=barg(L,1);b=(b>>24)|((b>>8)&0xff00)|((b&0xff00)<<8)|(b<<24);lua_pushnumber(L,(lua_Number)(int)(b));return 1;}
